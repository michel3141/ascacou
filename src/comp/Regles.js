...
<li><a href="#tour-de-jeu">Tour de jeu</a></li>
...
<p>Toute carte reproduite est mise de côté, même si un joueur reproduit une carte de son adversaire.</p>
<p>Les cartes déjà reproduites sur le plateau, et mises de côté, restent visibles, et permettent ainsi de vérifier qu'elles ne seront pas reproduites une nouvelle fois.</p>
...
<p>Le joueur tiré au sort pour commencer la partie doit également tirer au sort un pion noir ou blanc.</p>
<p>Après avoir joué son propre coup, le joueur choisit la couleur du pion qui sera joué par son adversaire.</p>

<p style={{textAlign: "right"}}><a href="img/regles.pdf" target="_blank">Télécharger la règles</a></p>
            </div>
      )
}
