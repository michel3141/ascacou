...
export default function Regles() {
  return (
    <div className='Regles'>
      ...
      <p>
        Ascacou se joue à deux, en disposant chacun son tour les pions noirs et blancs sur le
        plateau.
      </p>
      ...
      <p>
        Répartir les 16 cartes motif entre les joueurs, à leur convenance. La répartition peut
        également être aléatoire.
      </p>
      <p>
        Les cartes doivent être visibles de tous, et toutes orientées de la même façon que le
        plateau grâce à l&apos;inscription Ascacou, afin d&apos;éviter d&apos;avoir deux cartes
        identiques.
      </p>
      ...
      <p>
        À son tour, le joueur choisit et pose un pion de couleur sur le plateau. La seule contrainte
        est qu’une carte motif ne peut être présente qu&apos;une seule fois sur le plateau.
      </p>
      <p>
        Dès qu&apos;une carte motif est reproduite sur le plateau, elle est mise de côté par le
        joueur qui la possède et ce joueur marque un point.
      </p>
      ...
      <p>
        Toute carte reproduite est mise de côté, même si un joueur reproduit une carte de son
        adversaire.
      </p>
      <p>
        Les cartes déjà reproduites sur le plateau, et mises de côté, restent visibles, et
        permettent ainsi de vérifier qu&apos;elles ne seront pas reproduites une nouvelle fois.
      </p>
      <p>
        Plusieurs cartes motif (4 au maximum) peuvent être reproduite en même temps, avec un seul
        pion joué. Elles sont alors toutes mises de côté.
      </p>
      <table style={{ textAlign: 'center', width: '100%' }}>
        <tbody>
          <tr className='odd'>
      ...
      <p>
        Une carte motif ne pouvant être reproduite qu&apos;une seule fois sur le plateau, certaines
        positions du plateau peuvent donc devenir interdites
      </p>
      <table style={{ textAlign: 'center', width: '100%' }}>
        <tbody>
          <tr className='odd'>
      ...
      <p>
        À son tour, un joueur choisit et pose un pion de couleur sur le plateau, sans contrainte. Si
        une carte est reproduite plusieurs fois sur le plateau, elle ne comptera qu&apos;un seul
        point.
      </p>
      <h2 id='pion-imposé'>Pion imposé</h2>
      <p>
        Le joueur tiré au sort pour commencer la partie doit également tirer au sort un pion noir ou
        blanc.
      </p>
      <p>
        Après avoir joué son propre coup, le joueur choisit la couleur du pion qui sera joué par son
        adversaire.
      </p>
