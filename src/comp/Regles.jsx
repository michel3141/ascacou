...
export default () => (
  <div className='Regles'>
    ...
    <p>
      ...
      façon que le plateau grâce à l'inscription Ascacou, afin d'éviter d'avoir
      deux cartes identiques.
    </p>
    <p>
      Les joueurs n’ont pas de couleur attribuée. Celui qui commence est tiré au
      sort.
    </p>
    <h2 id='tour-de-jeu'>
      Tour de jeu
    ...
    <p>
      Après avoir joué son propre coup, le joueur choisit la couleur du pion qui
      sera joué par son adversaire.
    </p>
